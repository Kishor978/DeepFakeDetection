...
def normalize_data():
    """returns a dictionary containing different data transformations for different datasets. 
    The transformations include augmentations, conversion to tensors, and normalization.
    """
